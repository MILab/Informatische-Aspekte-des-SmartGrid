...
\ifoot{ \hrule \vspace{1mm} \small{Erstellt am: \today \ von C. van Heteren-Frese \\
Grafik "Task": CC BY-SA 3.0 Fiona Macintosh} } 
\begin{document}
...
\includegraphics[scale=0.3]{images/mask}\\  % Logo rechtsbündig
\hline
\end{tabularx}
% === HEADER END ===
